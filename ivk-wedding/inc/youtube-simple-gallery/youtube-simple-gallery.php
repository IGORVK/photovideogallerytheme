...
//load_theme_textdomain('youtube-simple-gallery', get_template_directory() . '/inc/youtube-simple-gallery/languages');

load_textdomain( 'youtube-simple-gallery',   dirname( __FILE__ )  . '/languages/youtube-simple-gallery-en_US.mo' );
...
function ysg_plugin_action_links( $links, $file ) {
   ...
   // $settings_link = '<a href="' . admin_url( 'admin.php?page=igor_ivk_wedding_video_gallery' ) . '">' . __( 'Configura&ccedil;&otilde;es Gerais', 'youtube-simple-gallery' ) . '</a>';
...
function ysg_script_UtubeGallery() {
	...
	wp_register_style( 'style-UtubeGallery', get_template_directory_uri(). '/inc/youtube-simple-gallery/assets/css/style-UtubeGallery.css' );
	wp_enqueue_style( 'style-UtubeGallery' );
}  
add_action('wp_print_scripts', 'ysg_script_UtubeGallery');

function ysg_admin_style() {
    wp_register_style( 'style.ysg.admin', get_template_directory_uri(). '/inc/youtube-simple-gallery/admin/css/style.ysg.admin.css' , false, '2.1.2', false );
...
function ysg_chrUtube_add_buttons($plugin_array) {
	$plugin_array['chrUtube'] = get_template_directory_uri(). '/inc/youtube-simple-gallery/admin/tinymce/chrUtube-tinymce.js';
	return $plugin_array;
}
...
function ysg_plugin_options() {
    //add_theme_page( 'YouTube Simple Gallery', __('YSG Configurações', 'youtube-simple-gallery'), 'manage_options', 'igor_ivk_wedding_video_gallery', 'ysg_plugin_options_page' );
