...
<div id="primary" class="content-area">
	...
	<main id="main" class="site-main" role="main">
        ...
        <div class="container container-ysg text-center">
	...
	global $ysg_options;
		...
		<?php
			if ( has_post_thumbnail()) {
				...
				echo '<img src="http://img.youtube.com/vi/'.$embed_code.'/maxresdefault.jpg" class="img-YoutubeGallery chr-size-image" alt="'.get_the_title().'" title="'.get_the_title().'" />';
			}
		?>
			<br />
		...
		jQuery(document).ready(function($) {
			$('a#intro-video-id-<?php the_ID(); ?>').click(function(){
                ...
                if (width <= 690) {
                    ...
                    $('.container-ysg iframe').css('width', '280px').css('height', '158px');
                }
                /*end ivk_wedding version*/
